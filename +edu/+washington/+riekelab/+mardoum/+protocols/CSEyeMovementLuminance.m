classdef CSEyeMovementLuminance < edu.washington.riekelab.protocols.RiekeLabStageProtocol
    ...
    methods
        ...
        function prepareRun(obj)
            ...
            % pull appropriate center & surround stimuli. Scale such that brightest point in original image is 1.0 on the monitor
        ...
        function prepareEpoch(obj, epoch)
            ...
            % Determine which stimulus to play this epoch. Cycles thru center, surround, center + surround
